...
if first_question.lower() == 'left':
    ...
    if second_question.lower() == 'wait':
        third_question = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color do you choose?")
        if third_question.lower() == 'blue':
            print("Eaten by beasts. Game Over.")
        elif third_question.lower() == 'red':
